...
import rpg.controller.MainController;
 ...
 */
    ...
    // 데이터의 처리를 담당할 MainController
    private MainController RPGManager = new MainController();
    ...
    public void talkToNPC() {
        ...
        System.out.println(selectedNPC.getNpcName() + "을/를 만났다!");
        System.out.println("============================");
